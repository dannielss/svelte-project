    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 22, 2, 354);
    			attr_dev(header, "class", "svelte-cbgezr");
    			add_location(header, file$4, 21, 0, 343);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 60, 4, 776);
    			attr_dev(h2, "class", "svelte-8tjse");
    			add_location(h2, file$3, 61, 4, 804);
    			attr_dev(p0, "class", "svelte-8tjse");
    			add_location(p0, file$3, 62, 4, 835);
    			attr_dev(header, "class", "svelte-8tjse");
    			add_location(header, file$3, 59, 2, 763);
    			...
    			add_location(img, file$3, 65, 4, 897);
    			attr_dev(div0, "class", "image svelte-8tjse");
    			add_location(div0, file$3, 64, 2, 873);
    			attr_dev(p1, "class", "svelte-8tjse");
    			add_location(p1, file$3, 68, 4, 983);
    			attr_dev(div1, "class", "content svelte-8tjse");
    			add_location(div1, file$3, 67, 2, 957);
    			attr_dev(a, "href", a_href_value = `malito:${/*meetup*/ ctx[0].email}`);
    			add_location(a, file$3, 71, 4, 1035);
    			add_location(button0, file$3, 72, 4, 1086);
    			add_location(button1, file$3, 73, 4, 1120);
    			attr_dev(footer, "class", "svelte-8tjse");
    			add_location(footer, file$3, 70, 2, 1022);
    			attr_dev(article, "class", "svelte-8tjse");
    			add_location(article, file$3, 58, 0, 751);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*meetup*/ 1 && a_href_value !== (a_href_value = `malito:${/*meetup*/ ctx[0].email}`)) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 103, 4, 2606);
    			attr_dev(form, "class", "svelte-zqiqb1");
    			add_location(form, file, 64, 2, 1427);
    			attr_dev(main, "class", "svelte-zqiqb1");
    			add_location(main, file, 63, 0, 1418);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
