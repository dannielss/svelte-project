    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 60, 4, 776);
    			attr_dev(h2, "class", "svelte-8tjse");
    			add_location(h2, file$2, 61, 4, 804);
    			attr_dev(p0, "class", "svelte-8tjse");
    			add_location(p0, file$2, 62, 4, 835);
    			attr_dev(header, "class", "svelte-8tjse");
    			add_location(header, file$2, 59, 2, 763);
    			...
    			add_location(img, file$2, 65, 4, 897);
    			attr_dev(div0, "class", "image svelte-8tjse");
    			add_location(div0, file$2, 64, 2, 873);
    			attr_dev(p1, "class", "svelte-8tjse");
    			add_location(p1, file$2, 68, 4, 983);
    			attr_dev(div1, "class", "content svelte-8tjse");
    			add_location(div1, file$2, 67, 2, 957);
    			attr_dev(a, "href", a_href_value = `malito:${/*meetup*/ ctx[0].email}`);
    			add_location(a, file$2, 71, 4, 1035);
    			add_location(button0, file$2, 72, 4, 1086);
    			add_location(button1, file$2, 73, 4, 1120);
    			attr_dev(footer, "class", "svelte-8tjse");
    			add_location(footer, file$2, 70, 2, 1022);
    			attr_dev(article, "class", "svelte-8tjse");
    			add_location(article, file$2, 58, 0, 751);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$1, 21, 0, 317);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-e9c58l");
